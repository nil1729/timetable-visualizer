      ...
      <v-card-text class="pb-0">
        ...
        <div class="text-body-2 font-weight-medium mt-0">
          <ul>
            ...
            <li>
              In the window that opens, select Import & Export from the left
              navigation bar.
            </li>
            <li>
              Browse the .ics file from your computer and upload it under the
              import heading.
            </li>
        ...
        <p class="font-weight-black mt-3">
          If you wish to skip these steps, you can directly get the .ics file
          mailed to your email address, following which you can import the
          events into Google Calendar by just opening the attached .ics file
        </p>
      </v-card-text>
...
export default {
  ...
  methods: {
    ...
    confirmQuery(chosenOption) {
      if (
        chosenOption === "email" &&
        !this.checkEmailIsValid(this.emailAddress)
      ) {
